...
module Spree
  describe Spree::Api::ProductPropertiesController, type: :request do
    ...
    it "cannot create a new product property if not an admin" do
      post :create, params: { product_property: { property_name: "My Property 3" } }
      assert_unauthorized!
    end

    it "cannot update a product property" do
      put :update, params: { id: property_1.property_name, product_property: { value: "my value 456" } }
      assert_unauthorized!
    end

    it "cannot delete a product property" do
      delete :destroy, params: { id: property_1.property_name }
      assert_unauthorized!
    ...
    context "as an admin" do
      ...
      it "can create a new product property" do
        expect do
          post :create, params: { product_property: { property_name: "My Property 3", value: "my value 3" } }
