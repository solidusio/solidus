module Spree
  module Api
    class PaymentsController < Spree::Api::BaseController
      ...
      around_filter :lock_order, only: [:create, :update, :destroy, :authorize, :capture, :purchase, :void]
      ...
      def create
        @payment, success = @order.contents.add_payment(payment_params: payment_params)
        if success
