...
describe Solidus::ProductsController, type: :controller do
  ...
  it "allows admins to view non-active products" do
    allow(controller).to receive_messages try_spree_current_user: mock_model(Solidus.user_class, has_spree_role?: true, last_incomplete_spree_order: nil, spree_api_key: 'fake')
  ...
  it "doesn't error when given an invalid referer" do
    current_user = mock_model(Solidus.user_class, has_spree_role?: true, last_incomplete_spree_order: nil, generate_spree_api_key!: nil)
