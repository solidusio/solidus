...
describe "Option Types", :js, type: :feature do
  ...
  it "lists option types and allows deleting them" do
    ...
    select_row("color")
    accept_turbo_confirm("Are you sure you want to delete 1 option type?") { click_on "Delete" }
  ...
  it "allows to edit and destroy option values" do
    ...
    select_row("green")
    accept_turbo_confirm("Are you sure you want to delete 1 option value?") { click_on "Delete" }
