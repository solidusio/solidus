...
module RailsApp
  class Application < Rails::Application
    ...
    routes.append do
      ...
      get '/solidus/seed' => ->env { Spree::Core::Engine.load_seed; [200, {}, ['Solidus seeds loaded']] }
      get '/solidus/samples' => ->env { SpreeSample::Engine.load_samples; [200, {}, ['Solidus samples loaded']] }
    end
  end
end
...
Spree.config { |config| config.mails_from = "store@example.com" }
...
*   http://localhost:3000/solidus/samples => loads sample data (requires seed)
