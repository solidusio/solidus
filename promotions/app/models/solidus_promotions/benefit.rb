...
module SolidusPromotions
  ...
  class Benefit < Spree::Base
    ...
    #
    # @return [Spree::Adjustment, SolidusPromotions::ItemDiscount, SolidusPromotions::ShippingRateDiscount, nil] An ItemDiscount object if a discount applies, nil if the amount is zero
    #
