  ...
  module Conditions
    class LineItemTaxon < Condition
      ...
      def line_item_eligible?(line_item, _options = {})
        ...
        when "include"
          condition_taxon_ids_with_children.any? { |taxon_and_descendant_ids| (line_item_taxon_ids & taxon_and_descendant_ids).any? }
        when "exclude"
          condition_taxon_ids_with_children.none? { |taxon_and_descendant_ids| (line_item_taxon_ids & taxon_and_descendant_ids).any? }
        else
