warn "DEPRECATION WARNING: Spree::BackendConfiguration::*_TABS is deprecated and will be removed in Spree 5.0. Please use Spree::BackendConfiguration::MenuItem(children:) instead."
