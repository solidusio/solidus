      ...
      "spree/admin/orders" => [
        ...
        },
        {
          ...
          locals: {
            ...
            label: -> { I18n.t("spree.shipment_state") },
            options: -> {
        ...
        },
        {
          ...
          locals: {
            ...
            label: -> { I18n.t("spree.order_number", number: "") }
          }
        },
        {
          partial: "spree/admin/shared/search_fields/text_field",
          locals: {
            ...
            label: -> { I18n.t("spree.shipment_number") }
          }
        },
        {
          partial: "spree/admin/shared/search_fields/text_field",
          locals: {
            ...
            label: -> { I18n.t("spree.name_contains") }
          }
        },
        {
          partial: "spree/admin/shared/search_fields/text_field",
        ...
        },
        {
          ...
          locals: {
            ...
            label: -> { I18n.t("spree.show_only_complete_orders") }
          }
        }
      ]
    }
