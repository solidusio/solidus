...
describe Solidus::Admin::ReturnAuthorizationsController, :type => :controller do
  ...
  describe "#load_return_reasons" do
    ...
    context "a return item in the return authorization has an associated inactive reason" do
      ...
      it "loads all the active rma reasons" do
        solidus_get :edit, id: return_authorization.to_param, order_id: return_authorization.order.to_param
  ...
  describe "#load_return_items" do
    ...
    context '#new' do
      subject { solidus_get :new, order_id: order.to_param }
  ...
  context '#create' do
    ...
    subject { solidus_post :create, params }
    ...
    it "can create a return authorization" do
      subject
      expect(response).to redirect_to solidus.admin_order_return_authorizations_path(order)
    end
  end
  ...
  context '#update' do
    ...
    subject { solidus_put :update, params }
