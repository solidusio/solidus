...
module Solidus
  module UserMethods
    ...
    included do
      ...
      has_many :spree_roles, through: :role_users, source: :role, class_name: "Solidus::Role"
      ...
      has_many :orders, foreign_key: "user_id", class_name: "Solidus::Order", dependent: :restrict_with_exception
      ...
      deprecate display_total_available_store_credit: :display_available_store_credit_total, deprecator: Solidus::Deprecation

      has_many :credit_cards, class_name: "Solidus::CreditCard", foreign_key: :user_id
      has_many :wallet_payment_sources, foreign_key: 'user_id', class_name: 'Solidus::WalletPaymentSource', inverse_of: :user
    ...
    deprecate total_available_store_credit: :available_store_credit_total, deprecator: Solidus::Deprecation
