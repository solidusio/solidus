...
module Spree
  ...
  class Order < Spree::Base
    ...
    self.allowed_ransackable_attributes = %w[bill_address_firstname_or_lastname completed_at created_at email number state payment_state shipment_state total store_id]
