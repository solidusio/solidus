      ...
      class CreateAdjustment < PromotionAction
        ...
        def perform(options = {})
          ...
          order.adjustments.create!(
            ...
            label: I18n.t('spree.adjustment_labels.order', promotion: Solidus::Promotion.model_name.human, promotion_name: promotion.name)
          )
          true
        end
        ...
        def compute_amount(calculable)
          ...
          if !amount.is_a?(BigDecimal)
            Solidus::Deprecation.warn "#{calculator.class.name}#compute returned #{amount.inspect}, it should return a BigDecimal"
          end
          amount ||= BigDecimal(0)
          amount = amount.abs
