...
class Spree::Wallet
  ...
  # Find a WalletSource in the wallet by the id of its PaymentSource.
  #
  # @param source_id [Integer] The id of the PaymentSource
  # @return [WalletSource]
  def find_by_source(source)
    user.wallet_sources.find_by(source: source)
  end
