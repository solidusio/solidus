module Spree
  ...
  class Adjustment < Solidus::Base
    ...
    belongs_to :order, class_name: 'Solidus::Order', inverse_of: :all_adjustments
    belongs_to :promotion_code, :class_name => 'Solidus::PromotionCode'
    belongs_to :adjustment_reason, class_name: 'Solidus::AdjustmentReason', inverse_of: :adjustments
    ...
    #
    # @param target [Solidus::LineItem,Solidus::Shipment,Solidus::Order] Deprecated: the target to calculate against
