      ...
      class CreateItemAdjustments < PromotionAction
        ...
        def compute_amount(adjustable)
          ...
          if !promotion_amount.is_a?(BigDecimal)
            Solidus::Deprecation.warn "#{calculator.class.name}#compute returned #{promotion_amount.inspect}, it should return a BigDecimal"
          end
        ...
        def create_adjustment(adjustable, order, promotion_code)
          ...
          adjustable.adjustments.create!(
            ...
            label: I18n.t('spree.adjustment_labels.line_item', promotion: Solidus::Promotion.model_name.human, promotion_name: promotion.name)
          )
          true
        end
