module Spree
  class Country < Solidus::Base
    ...
    def self.states_required_by_country_id
      ActiveSupport::Deprecation.warn "Solidus::Country.states_required_by_country_id is deprecated and will be removed from future releases, Implement it yourself.", caller
    ...
    def self.default
      if default_country_id = Solidus::Config[:default_country_id]
