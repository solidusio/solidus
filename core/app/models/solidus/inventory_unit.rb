module Spree
  class InventoryUnit < Solidus::Base
    ...
    belongs_to :variant, -> { with_deleted }, class_name: "Solidus::Variant", inverse_of: :inventory_units
    belongs_to :order, class_name: "Solidus::Order", inverse_of: :inventory_units
    belongs_to :shipment, class_name: "Solidus::Shipment", touch: true, inverse_of: :inventory_units
    belongs_to :return_authorization, class_name: "Solidus::ReturnAuthorization", inverse_of: :inventory_units
    belongs_to :carton, class_name: "Solidus::Carton", inverse_of: :inventory_units
    belongs_to :line_item, class_name: "Solidus::LineItem", inverse_of: :inventory_units
