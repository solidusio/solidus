...
require 'solidus/event/subscriber'
  ...
  module MailerSubscriber
    ...
    def order_finalized(event)
      ...
      unless order.confirmation_delivered?
        Solidus::Config.order_mailer_class.confirm_email(order).deliver_later
    ...
    def send_reimbursement_email(event)
      ...
      Solidus::Config.reimbursement_mailer_class.reimbursement_email(reimbursement.id).deliver_later
    end
  end
end
