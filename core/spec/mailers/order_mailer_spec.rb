  ...
  context "emails must be translatable" do
    ...
    context "pt-BR locale" do
      before do
        ...
        pt_br_confirm_mail = { :solidus => { :order_mailer => { :confirm_email => { :dear_customer => 'Caro Cliente,' } } } }
        pt_br_cancel_mail = { :solidus => { :order_mailer => { :cancel_email => { :order_summary_canceled => 'Resumo da Pedido [CANCELADA]' } } } }
