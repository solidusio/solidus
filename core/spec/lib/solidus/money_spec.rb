...
describe Solidus::Money do
  ...
  context "with currency" do
    it "passed in option" do
      money = Solidus::Money.new(10, :with_currency => true, :html => false)
  ...
  context "currency parameter" do
    context "when currency is specified in Canadian Dollars" do
      it "uses the currency param over the global configuration" do
        money = Solidus::Money.new(10, :currency => 'CAD', :with_currency => true, :html => false)
    ...
    context "when currency is specified in Japanese Yen" do
      it "uses the currency param over the global configuration" do
        money = Solidus::Money.new(100, :currency => 'JPY', :html => false)
  ...
  context "symbol positioning" do
    it "passed in option" do
      money = Solidus::Money.new(10, :symbol_position => :after, :html => false)
      expect(money.to_s).to eq("10.00 $")
    end
  ...
  context "JPY" do
    ...
    it "formats correctly" do
      money = Solidus::Money.new(1000, :html => false)
  ...
  context "EUR" do
    ...
    it "formats as plain by default" do
      money = Solidus::Money.new(10, symbol_position: :after)
      expect(money.to_s).to eq("10.00 €")
    end
    ...
    it "formats as HTML with currency" do
      money = Solidus::Money.new(10, symbol_position: :after, with_currency: true)
      # The HTML'ified version of "10.00 €"
