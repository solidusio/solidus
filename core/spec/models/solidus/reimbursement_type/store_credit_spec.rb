...
module Solidus
  describe ReimbursementType::StoreCredit do
    ...
    let!(:created_by_user)        { create(:user, email: Solidus::StoreCredit::DEFAULT_CREATED_BY_EMAIL) }
    let!(:default_reimbursement_category) { create(:store_credit_category) }

    subject { Solidus::ReimbursementType::StoreCredit.reimburse(reimbursement, [return_item, return_item2], simulate)}
