...
describe Solidus::Calculator::DefaultTax, :type => :model do
  ...
  let!(:calculator) { Solidus::Calculator::DefaultTax.new(:calculable => rate ) }
      ...
      context "when the variant matches the tax category" do
        ...
        context "when line item is discounted" do
          before do
            ...
            Solidus::TaxRate.store_pre_tax_amount(line_item, [rate])
          end
