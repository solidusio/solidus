...
describe Solidus::PaymentMethod, :type => :model do
  describe ".available" do
    ...
    it "should return all methods available to front-end when display_on = :front_end" do
      expect(Solidus::PaymentMethod.available(:front_end).size).to eq(2)
    end

    it "should return all methods available to back-end when display_on = :back_end" do
      expect(Solidus::PaymentMethod.available(:back_end).size).to eq(2)
    end
