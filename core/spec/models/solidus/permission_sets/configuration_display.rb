...
describe Solidus::PermissionSets::ConfigurationDisplay do
  ...
  context "when activated" do
    ...
    it { is_expected.to be_able_to(:display, Solidus::Tracker) }
    ...
    it { is_expected.to be_able_to(:admin, Solidus::Tracker) }
  ...
  context "when not activated" do
    ...
    it { is_expected.not_to be_able_to(:display, Solidus::Tracker) }
    ...
    it { is_expected.not_to be_able_to(:admin, Solidus::Tracker) }
