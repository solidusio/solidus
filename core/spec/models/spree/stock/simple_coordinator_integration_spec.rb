  ...
  context "when custom coordinator options are passed" do
    ...
    describe "to customize the allocator's behavior" do
      ...
      around do |example|
        ...
        original_allocator_class = MyAllocator.to_s
        Spree::Config.stock.allocator_class = MyAllocator.to_s
        example.run
        Spree::Config.stock.allocator_class = original_allocator_class
      end
    ...
    describe "to customize the stock locator filter behavior" do
      ...
      around do |example|
        ...
        example.run
        Spree::Config.stock.location_filter_class = original_locator_filter_class
      end
