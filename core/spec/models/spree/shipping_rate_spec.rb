...
describe Spree::ShippingRate, type: :model do
  ...
  context "#display_price" do
    ...
    let(:other_zone) { create :zone, countries: [foreign_country] }
    ...
    context 'with one included tax rate' do
      ...
      before do
        Spree::Config.default_country_iso = address.country.iso
        Spree::Config.default_tax_address = Spree::Address.build_default
      end
