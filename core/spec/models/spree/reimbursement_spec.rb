...
describe Spree::Reimbursement, type: :model do
  ...
  describe "#perform!" do
    ...
    let(:order)                   { create(:order_with_line_items, state: 'payment', line_items_count: 1, line_items_price: line_items_price, shipment_cost: 0, shipping_method: shipping_method) }
