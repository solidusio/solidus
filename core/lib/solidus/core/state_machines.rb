    ...
    class StateMachines
      ...
      def return_authorization
        @return_authorization ||= begin
          require 'solidus/core/state_machines/return_authorization'
      ...
      def return_item_reception
        @return_item_reception_status ||= begin
          require 'solidus/core/state_machines/return_item/reception_status'
      ...
      def return_item_acceptance
        @return_item_acceptance_status ||= begin
          require 'solidus/core/state_machines/return_item/acceptance_status'
      ...
      def payment
        @payment ||= begin
          require 'solidus/core/state_machines/payment'
      ...
      def inventory_unit
        @inventory_unit ||= begin
          require 'solidus/core/state_machines/inventory_unit'
      ...
      def shipment
        @shipment ||= begin
          require 'solidus/core/state_machines/shipment'
      ...
      def reimbursement
        @reimbursement ||= begin
          require 'solidus/core/state_machines/reimbursement'
