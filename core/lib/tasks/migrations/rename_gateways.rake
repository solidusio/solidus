...
namespace 'solidus:migrations:rename_gateways' do
  task up: :environment do
    Solidus::Deprecation.warn("rake solidus:migrations:rename_gateways:up has been deprecated and will be removed with Solidus 3.0.")
  ...
  task down: :environment do
    Solidus::Deprecation.warn("rake solidus:migrations:rename_gateways:down has been deprecated and will be removed with Solidus 3.0.")
