...
Retreiving data for a specific order number can be done with this simple request:
...
Only the user who owns the order or authorized users can access the order or they
