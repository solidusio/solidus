...
RSpec.describe SolidusFriendlyPromotions::CodeBatch, type: :model do
  subject do
  ...
  describe "#process" do
    context "with a pending code batch" do
      it "should call the worker" do
        expect { subject.process }
          .to have_enqueued_job(SolidusFriendlyPromotions::CodeBatchJob)
      end
    ...
    context "with a processing batch" do
      ...
      it "should raise an error" do
        expect{ subject.process }.to raise_error SolidusFriendlyPromotions::CodeBatch::CantProcessStartedBatch
      end
    end
