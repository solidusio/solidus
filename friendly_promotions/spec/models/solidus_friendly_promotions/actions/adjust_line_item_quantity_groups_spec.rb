...
RSpec.describe SolidusFriendlyPromotions::Actions::AdjustLineItemQuantityGroups do
  ...
  describe "#compute_amount" do
    ...
    context "with a flat rate adjustment" do
      let(:calculator) { SolidusFriendlyPromotions::Calculators::FlatRate.new(preferred_amount: 5) }
    ...
    context "with a tiered percentage based adjustment" do
      ...
      let(:calculator) do
        SolidusFriendlyPromotions::Calculators::TieredPercent.create(preferred_base_percent: 10, preferred_tiers: tiers)
      end
      let(:line_items_attributes) do
        [
          {price: 10, quantity: 1}.merge(line_one_options),
